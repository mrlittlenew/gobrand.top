...
Pace.on("hide",function(){
 ...
 function p2(){
        ...
        var checkP1 = setInterval(function(){
            ...
            if (ii == 20) clearInterval(checkP1);
            ii++;
        },500)
 }
 ...
 function p3(){
        ...
        var checkP1 = setInterval(function(){
            ...
            if (ii == 12) clearInterval(checkP1);
            ii++;
        },500)
 }
 function p4(){
 ...
 $("#choujiang").click(function(){
 	...
 	setTimeout(function(){
        ...
        success:function(result) {
            ...
            setTimeout(function(){
                $(".panel5").addClass("on").find(".txt").text(result.resultData.prizeName);
            },1000)
        },  
        timeout:3000  
    });  
 ...
 var qyData = [
 	{
 		...
 		logo:"logo-afyl.jpg",
 		ewm:"ewm-afyl.jpg",
 		lipin:['奥飞纪念品','喜洋洋/贝肯熊','再接再厉','复试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"dfwl",
 		name:"东方网力",
 		logo:"logo-dfwl.jpg",
 		ewm:"ewm-dfwl.jpg",
 		lipin:['笔记本套装','再接再厉','面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"dzyl",
 		name:"东芝医疗",
 		logo:"logo-dzyl.jpg",
 		ewm:"ewm-dzyl.jpg",
 		lipin:['核磁扫描体验卡','再接再厉','精美手电','笔试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"jindie",
 		name:"金蝶集团",
 		...
 		ewm:"ewm-jindie.jpg",
 		lipin:['文化印象笔记本','再接再厉','面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"jindong",
 		name:"京东集团",
 		...
 		ewm:"ewm-jindong.jpg",
 		lipin:['Joy公仔周边','再接再厉','笔试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"libai",
 		name:"立白集团",
 		logo:"logo-libai.jpg",
 		ewm:"ewm-libai.jpg",
 		lipin:['洗衣露（组合）','驱蚊液（组合）','笔试直通卡','面试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"lzlj",
 		name:"泸州老窖",
 		logo:"logo-lzlj.jpg",
 		ewm:"ewm-lzlj.jpg",
 		lipin:['国窖1573','百年窖龄酒','精美U盘','测评直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"suningkonggu",
 		name:"苏宁控股集团",
 		...
 		lipin:['绝版小狮子玩偶','《苏宁为什么赢》','PPTV会员卡','面试直通卡/简历诊断卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"tjgf",
 		name:"太极股份",
 	...
 	},
 	{
 		...
 		logo:"logo-xinao.jpg",
 		ewm:"ewm-xinao.jpg",
 		lipin:['移动电源','精美U盘','DIY心情灯','笔试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"ywzg",
 		name:"永旺中国",
 		logo:"logo-ywzg.jpg",
 		ewm:"ewm-ywzg.jpg",
 		lipin:['精美礼品','再接再厉','面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"tcl",
 		name:"TCL",
 	...
 	},
 	{
 		...
 		logo:"logo-hnd.jpg",
 		ewm:"ewm-hnd.jpg",
 		lipin:['对讲机U盘','保温杯','马克杯','终面直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"hdjy",
 		name:"华大基因",
 		logo:"logo-hdjy.jpg",
 		ewm:"ewm-hdjy.jpg",
 		lipin:['双肩电脑包','基因钥匙扣','熊猫U盘','面试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"kp",
 		name:"酷派",
 	...
 	},
 	{
 		...
 		logo:"logo-lbyq.jpg",
 		ewm:"ewm-lbyq.jpg",
 		lipin:['限量版记事本','笔试直通卡','熊猫U盘','面试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"pingan",
 		name:"平安集团",
 	...
 	},
 	{
 		...
 		logo:"logo-pakj.jpg",
 		ewm:"ewm-pakj.jpg",
 		lipin:['小Y公仔','再接再厉','面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"tcbj",
 		name:"汤臣倍健",
 		logo:"logo-tcbj.jpg",
 		ewm:"ewm-tcbj.jpg",
 		lipin:['维生素c片','再接再厉','初面直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"zxtx",
 		name:"中兴通讯",
 	...
 	},
 	{
 		...
 		logo:"logo-jes.jpg",
 		ewm:"ewm-jes.jpg",
 		lipin:['精美笔','精美笔记本','面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"dongruan",
 		name:"东软集团",
 		...
 		lipin:['精美U盘','纪念水杯','电脑刷','笔试直通卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"tnly",
 		name:"途牛旅游",
 	...
 	},
 	{
 		...
 		logo:"logo-sddc.jpg",
 		ewm:"ewm-sddc.jpg",
 		lipin:['笔试直通卡','再接再厉','精美笔记本','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"zldcjd",
 		name:"中粮地产酒店",
 		...
 		ewm:"ewm-zldcjd.jpg",
 		lipin:['大悦城礼品','大悦城会员卡','简历诊断卡','面试辅导卡','uber新用户券','再接再厉']
 	},
 	{
 		jc:"yuanyang",
 		name:"远洋集团",
 	...
 	},
 	{
 		...
 		logo:"logo-hhjc.jpg",
 		ewm:"ewm-hhjc.jpg",
 		lipin:['精美书签','再接再厉','笔/面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"glj",
 		name:"高露洁",
 		logo:"logo-glj.jpg",
 		ewm:"ewm-glj.jpg",
 		lipin:['口腔护理礼包','再接再厉','实习面试直通卡','再接再厉','uber新用户券','再接再厉']
 	},
 	{
 		jc:"hj",
 		name:"沪江",
 		logo:"logo-hj.jpg",
 		ewm:"ewm-hj.jpg",
 		lipin:['学习卡','再接再厉','简历诊断卡','笔试直通卡','uber新用户券','再接再厉']
 	}
 ]